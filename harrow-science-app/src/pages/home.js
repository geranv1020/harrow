	...
	return (
		<>
			...
			<section className="home-s2">
				<div className="container">
					<p>
						At Harrow Medical Affairs, our mission is to challenge the
						scientific landscape, by partnering with physicians to advance the
						science around necessary and sight saving medications for the
						patients we serve.
					</p>
				</div>
