            ...
            <section className="pagetitle-inv">
                    <div className="container pgc">
                        ...
                        <div className="pagetitle-text">
                            ...
                            <h3>Please fill out the following form to submit your proposal.</h3>
                        </div>
                    </div>
            </section>
            {/* <!-- ==============================PAGETITLE SECTION--> */}
                    ...
                    <div className="container iit-form" id="iit-form" onSubmit={handleSubmit}>
                        <form className="form-input-rows">
                            <div className="row iit-row">
                                ...
                                <div className="col-md-6 iit-col" key="4">
                            ...
                            <div className="row iit-row">
                                <div className="col-md-6 iit-col" key="3">
                                ...
                                <div className="col-md-6 iit-col" key="2">
                            ...
                            <div className="row iit-row">
                                ...
                                <div className="col-md-6 iit-col" key="6">
                                    <label for="product">Product*</label>
                                    <select name="product" id="product-select" required="Required"
                            ...
                            <div className="resume-section">
                                <div class="resume">
                                    <h3>Resume</h3>
                                    <h4>Please be sure to include an updated resume</h4>
                                    <button class="resume-btn">Upload resume</button>
                                    <h5>DOC, DOCX, PDF (2MB)</h5>
                                </div>
                            </div>
                            <div className="iit-form-submit">
